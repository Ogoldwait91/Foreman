                        ...
                        children: [
                          ...
                          PopupMenuButton<String>(
                            ...
                            itemBuilder: (ctx) => [
                              ...
                              const PopupMenuItem(value: "share", child: ListTile(leading: Icon(Icons.ios_share), title: Text("Share PDF"))),
                              const PopupMenuItem(value: "save", child: ListTile(leading: Icon(Icons.save), title: Text("Save PDF"))),
                              const PopupMenuDivider(),
                              const PopupMenuItem(value: "markPaid", child: ListTile(leading: Icon(Icons.check_circle), title: Text("Mark paid"))),
                              const PopupMenuItem(value: "markSent", child: ListTile(leading: Icon(Icons.outgoing_mail), title: Text("Mark sent"))),
                            ],
                          ),
                        ],
                      ),
