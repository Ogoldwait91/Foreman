...
class _NewInvoiceScreenState extends State<NewInvoiceScreen> {
  ...
  @override
  void dispose() {
    _clientName.dispose(); _jobName.dispose(); _itemDesc.dispose(); _qty.dispose(); _unitPrice.dispose();
    super.dispose();
  }
  ...
  void _saveDraft() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Invoice draft saved.")));
        ...
        child: ListView(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: const InputDecoration(
                      filled: true, fillColor: ForemanColors.card, labelText: "Qty",
                      border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(12))),
                    ),
                ...
                Expanded(
                  child: TextFormField(
                    controller: _unitPrice, keyboardType: const TextInputType.numberWithOptions(decimal: true),
                    decoration: const InputDecoration(
            ...
            SwitchListTile(
              ...
              value: _vatApplicable, onChanged: (v) => setState(() => _vatApplicable = v),
            ),
