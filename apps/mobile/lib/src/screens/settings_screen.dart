...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    _vat = TextEditingController(text: (s.vatRate * 100).toStringAsFixed(0)); // e.g. "20"
    _tax = TextEditingController(text: (s.taxReserveRate * 100).toStringAsFixed(0)); // e.g. "25"
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const Text("Rates", style: TextStyle(color: ForemanColors.white, fontWeight: FontWeight.w700, fontSize: 18)),
